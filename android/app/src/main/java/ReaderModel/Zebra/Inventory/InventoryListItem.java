package ReaderModel.Zebra.Inventory;
...
public class InventoryListItem {
     ...
     * @param memoryBankData - memoryBankData associated // * @param EPCId - EPCIDSTARTWITH of the tag
     * @param RSSI           - RSSI value of the tag
     * @param phase          - Phase of the tag
     * @param channelIndex   - ChannelIndex
     * @param PC             - PC value for the tag
     */
    public InventoryListItem(String tagID, int count, String memoryBank, String memoryBankData,
                             String RSSI, String phase, String channelIndex, String PC) {
        this.tagID = tagID;
        this.count = count;
