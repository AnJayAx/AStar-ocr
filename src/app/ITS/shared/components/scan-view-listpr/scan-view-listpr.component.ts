...
@Component({
  selector: 'app-scan-view-listpr',
  templateUrl: './scan-view-listpr.component.html',
  styleUrls: ['./scan-view-listpr.component.scss']
})
export class ScanViewListprComponent implements OnInit, OnDestroy, AfterViewInit {
